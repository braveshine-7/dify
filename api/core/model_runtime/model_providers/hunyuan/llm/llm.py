...
"""
    ...
    def _generate(self, model: str, credentials: dict,
        ...
        client = hunyuan_client.HunyuanClient(credentials_kwargs,"",clientProfile)
        ...
        # else:
        # if mode == LLMMode.CHAT:
        params["Messages"] = self._convert_prompt_messages_to_tencent_messages(prompt_messages)
    ...
    def _handle_generate_response(self, model: str, credentials: dict, response: types.GeneratorType,
    ...
    def _to_credential_kwargs(self, credentials: dict) -> dict:
        ...
        """
        # credentials_kwargs = {
        #     "Secret_Id": credentials['tencent_Secret_Id'],
        #     "Secret_Key": credentials['tencent_Secret_Key'],
        # }
        credentials_kwargs =  credential.Credential(credentials['tencent_Secret_Id'],credentials['tencent_Secret_Key'])
    ...
    def _convert_prompt_messages_to_tencent_messages(self, prompt_messages: list[PromptMessage],
                                                    rich_content: bool = False) -> list[dict]:
        """
        Convert prompt messages to tencent messages

        :param prompt_messages: prompt messages
        :return: tencent messages
        """
        tencent_messages = []
        for prompt_message in prompt_messages:
            if isinstance(prompt_message, SystemPromptMessage):
                tencent_messages.append({
                    'Role': 'system',
